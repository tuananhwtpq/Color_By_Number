...
if [[ $# -lt 2 ]]; then
  ...
  echo "bash tools/import_category_from_data.sh "Data/Cat Moments" --target-category "Collection/Cat Moments" --source-line-format svg --overwrite --allow-low-quality --continue-on-error"
  exit 1
