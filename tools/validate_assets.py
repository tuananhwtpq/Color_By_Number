...
def flatten_row(row):
    ...
    return {
        ...
        "playability_profile": metrics.get("playability_profile", ""),
        ...
        "flat_similarity_score": metrics.get("flat_similarity_score", ""),
...
COMPACT_TABLE_COLUMNS = [
    ...
    {"key": "playability_profile", "title": "profile", "align": "left"},
    ...
    {"key": "detail_dependency_score", "title": "detail_dep", "align": "right"},
    {"key": "overmerge_risk", "title": "overmerge", "align": "left"},
...
FULL_TABLE_COLUMNS = [
    ...
    {"key": "preview_similarity_score", "title": "sim", "align": "right"},
    {"key": "flat_similarity_score", "title": "flat_sim", "align": "right"},
    {"key": "detail_dependency_score", "title": "detail_dep", "align": "right"},
    {"key": "raw_region_count", "title": "raw_regions", "align": "right"},
    {"key": "final_region_count", "title": "final_regions", "align": "right"},
    {"key": "region_count_drop_pct", "title": "drop%", "align": "right"},
    {"key": "overmerge_risk", "title": "overmerge", "align": "left"},
        ...
        table_rows.append(
            {
                ...
                "flat_similarity_score": format_pct(metrics.get("flat_similarity_score")),
                "detail_dependency_score": format_pct(metrics.get("detail_dependency_score")),
                "raw_region_count": metrics.get("raw_region_count"),
                "final_region_count": metrics.get("final_region_count"),
                "region_count_drop_pct": format_pct(metrics.get("region_count_drop_pct")),
                "overmerge_risk": metrics.get("overmerge_risk"),
