 ...
 * và phần đã đạt tô gradient đỏ → cam → vàng. Chữ trạng thái ("3/9") nằm giữa thanh.
 *
...
class AchievementProgressView @JvmOverloads constructor(
    ...
    init {
        ...
        context.obtainStyledAttributes(
            attrs,
            R.styleable.AchievementProgressView,
            defStyleAttr,
            0
        ).use { attributes ->
            trackPaint.color = attributes.getColor(
                R.styleable.AchievementProgressView_achievementTrackColor,
                ContextCompat.getColor(context, R.color.white_20)
            )
            tvStatus.setTextColor(
                attributes.getColor(
                    R.styleable.AchievementProgressView_achievementProgressTextColor,
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        // thấy phần đỏ, càng đầy càng chuyển qua cam rồi vàng.
